...
required_files=(
  ...
  "$ROOT_DIR/docs/upgrade-plans/test-first-validation-upgrade-plan.md"
  "$ROOT_DIR/docs/upgrade-plans/test-first-validation-implementation/01-validation-and-test-plan.md"
  "$ROOT_DIR/docs/upgrade-plans/test-first-validation-implementation/02-iteration-plan.md"
  "$ROOT_DIR/docs/upgrade-plans/test-first-validation-implementation/03-validation-results.md"
  ...
  "$ROOT_DIR/skill/complex-task-orchestrator/references/validation-first-workflow.md"
  "$ROOT_DIR/skill/complex-task-orchestrator/references/validation-plan-template.md"
...
grep -q "测试与验收设计" "$ROOT_DIR/skill/complex-task-orchestrator/SKILL.md"
grep -q "执行计划生成" "$ROOT_DIR/skill/complex-task-orchestrator/SKILL.md"
grep -q "预设验证回验" "$ROOT_DIR/skill/complex-task-orchestrator/SKILL.md"
grep -q "失败迭代" "$ROOT_DIR/skill/complex-task-orchestrator/SKILL.md"
...
grep -q "02-validation-and-test-plan.md" "$ROOT_DIR/skill/complex-task-orchestrator/references/artifact-conventions.md"
grep -q "03-execution-plan.md" "$ROOT_DIR/skill/complex-task-orchestrator/references/artifact-conventions.md"
grep -q "04-self-review-and-summary.md" "$ROOT_DIR/skill/complex-task-orchestrator/references/artifact-conventions.md"
grep -q "自检不能替代" "$ROOT_DIR/skill/complex-task-orchestrator/references/self-review-checklist.md"
grep -q "预设验证回验不是扩展验证" "$ROOT_DIR/skill/complex-task-orchestrator/references/definition-of-done.md"
grep -q "^# Validation First Workflow$" "$ROOT_DIR/skill/complex-task-orchestrator/references/validation-first-workflow.md"
grep -q "^# Validation Plan Template$" "$ROOT_DIR/skill/complex-task-orchestrator/references/validation-plan-template.md"
grep -q "02-validation-and-test-plan.md" "$ROOT_DIR/README.md"
grep -q "02-validation-and-test-plan.md" "$ROOT_DIR/README_EN.md"
